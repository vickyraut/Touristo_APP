...
$sql = "select id, name, city, country, image, description, latitude, longitude, price, days, likes, rating, liked_status FROM tourist_places WHERE liked_status='1'";
...
echo json_encode(array('getSavedPlaces' => $result));
?>