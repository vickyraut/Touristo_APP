...
public class story_model {
    ...
    public story_model(String name, String city, String country, String image, String description, String days, int price, int likes, double rating, double latitude, double longitude, int liked_status) {
        this.name = name;
        this.city = city;
